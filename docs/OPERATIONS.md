...
`templates/report-master.json` 固定日报的正式视觉与编辑母版。当前母版是 `2026-08-26-editorial-v3.1`，指向 `content/zh/20260826_ALUX_AI智能体情报日报.html`；新一期只复制它的结构与 CSS，并遵守 12-18 条目标（5-7 条详报，其余短讯；不足需补查并记录原因）、普通开发工具维护更新最多 2 条、趣味发现目标至少 3 条、首屏精简、统计语义分离和导读/雷达分工，不以最近一期滚动继承版式。
...
1. 分析文章结构、读者、专名、数字、公共选题类别与证据边界。RISC 只保留前置机器说明。
