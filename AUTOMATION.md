...
4. 确认正文含当前版本标记 `[ALUX_DAILY_CONTRACT_VERSION: 3.2.0]`。
...
1. 先读取 `templates/report-master.json`，按其固定的 `2026-08-21-compact-v1` 母版生成中文母稿并保存到 `content/zh/`；不得把“最近一期”当作可逐日漂移的新母版。
