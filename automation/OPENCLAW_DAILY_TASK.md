...
5. 页面布局、类名、颜色、字体层级和响应式行为只以 `templates/report-master.json` 固定的 `2026-08-26-editorial-v3` 为母版；复制该母版结构和 CSS，只替换当日日期、事实、标题、数字、链接、摘要和判断。不得改用最近一期滚动继承，也不得复制旧事实和旧判断。
